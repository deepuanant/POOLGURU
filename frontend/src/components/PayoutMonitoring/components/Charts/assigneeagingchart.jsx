...
const AssigneeAgeingDonutChart = ({ data }) => {
  ...
  const chartData = data?.npaMetrics?.map((item) => ({
    name: item.finalNpa,
    value: item.count,
  }));
  ...
  const handleDownload = async () => {
    ...
    if (chartRef.current) {
      ...
      link.download = "AssigneeAgeingDonutChart.png";
      link.click();
    }
        ...
        <ResponsiveContainer width="100%" height={220}>
          <PieChart>
            ...
            <Pie
              ...
              cx="50%"
              cy="50%"
              innerRadius={50} // Create the inner hole for donut effect
              outerRadius={90}
              fill="#8884d8"
            >
            ...
            <Legend
              ...
              height={36}
              wrapperStyle={{ fontSize: "12px", color: "#4B5563" }} // Reduced font size
...
export default AssigneeAgeingDonutChart;
